...
from .evaluate_function import schema_evaluate
from google.genai import types

available_functions = types.Tool(
    function_declarations=[schema_get_files_info, schema_get_file_content, 
                           schema_write_file, schema_run_python_file, schema_evaluate],
)
...
def call_function(function_call: types.FunctionCall, verbose=False) -> types.Content:
    ...
    function_registry = {
        ...
        "evaluate" : _run_evaluate_function
    }
